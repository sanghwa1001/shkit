...
function renderAvatarList() {
    ...
    (localStudentAccounts[currentUser]?.ownedAvatars || DEFAULT_AVATARS).forEach(avatarId => {
        ...
        let avatarName = (avatarId === 'images/avatars/image_0.gif') ? '기본 남자' : (avatarId === 'images/avatars/image_1.gif') ? '기본 여자' : (localShopNames[avatarId.replace('.', '_')] || `${avatarId.split('/').pop().split('.')[0]}번 아바타`);
